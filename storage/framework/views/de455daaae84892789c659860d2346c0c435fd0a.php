...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
        <nav class="navbar sticky-top navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="/"><img class="c-logo" src="<?php echo e(asset('img/KST Logo2018.JPG')); ?>" alt="PT. Kreatifitas Sinergisme Teknoindo" height="80" /></a>
        ...
        <main class="container">
            <section id="hero" class="d-flex flex-wrap justify-content-between">
                ...
                <div class="col-lg-6 col-sm-12">
                    <img class="img-fluid" src="<?php echo e(asset('img/hero_background 2.png')); ?>" alt="">
                </div>
            </section>
            <hr>
            <section id="services" class="d-flex flex-column">
                ...
                <div class="card mb-3 p-3">
                    <div class="d-flex flex-wrap">
                        <div class="col-lg-6 p-3 text-center justify-content-center align-items-center">
                            <img style="max-width:300px" src="<?php echo e(asset('img/Software Dev.png')); ?>" alt="Product Development" class="img-fluid">
                        </div>
                ...
                <div class="card p-3">
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 p-3 text-center justify-content-center align-items-center">
                            <img src="<?php echo e(asset('img/Outsourcing.png')); ?>" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="clients" class="d-flex flex-column mb-5">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 d-flex text-center justify-content-center align-items-center">
                        <img src="<?php echo e(asset('img/gapbuster_logo.gif')); ?>" alt="GBW" class="img-fluid">
                    </div>
                    <div class="col-lg-6 col-sm-6 d-flex text-center justify-content-center align-items-center">
                        <img src="<?php echo e(asset('img/Gadens-logo.png')); ?>" alt="Gadens" class="img-fluid">
                    </div>
                </div>
            </section>
        </main>
...
</html><?php /**PATH C:\xampp\htdocs\Judo-Website-v3\resources\views/welcome.blade.php ENDPATH**/ ?>